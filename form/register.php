...
if ((isset($_POST['package'])) && (strlen(trim($_POST['package'])) > 0)) {
	$package = stripslashes(strip_tags($_POST['package']));
} else {$package = 'No package selected';}
ob_start();
